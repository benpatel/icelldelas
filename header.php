                            ...
                            <li>
                                ...
                                <div class="vertical-dropdown-menu">
                                    <div class="vertical-groups col-sm-12">
                                        ...
                                        <div class="mega-group col-sm-4">
                                            <div class="mega-custom-html c">
                                                <a href="#"><img class="img-responsive" src="assets/data/girls.png" alt="girls.png"></a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                        ...
                                        <ul class="mega_dropdown dropdown-menu" style="width: 830px; left: -197px;">
                                            <li class="block-container col-sm-6">
                                                <ul class="block">
                                                    <li class="img_container">
                                                        <a href="#" title="">
                                                            <img class="img-responsive" src="assets/data/sport.png" alt="sport">
                                                        </a>
                                                    </li>   
                                                </ul>
                                            </li>
                                            ...
                                            <li class="block-container col-sm-3">
                                                <ul class="block">
                                                    ...
                                                    <li class="img_container">
                                                        <a href="#">
                                                            <img class="img-responsive" src="assets/data/ckoo.png" alt="sport">
                                                        </a>
                                                    </li>
                                                    <li class="img_container">
                                                        <a href="#">
                                                            <img class="img-responsive" src="assets/data/chaneee.png" alt="sport">
                                                        </a>
                                                    </li>
                                                    <li class="img_container">
                                                        <a href="#">
                                                            <img class="img-responsive" src="assets/data/loreee.png" alt="sport">
                                                        </a>
                                                    </li>
                                                </ul>
                                            </li>
